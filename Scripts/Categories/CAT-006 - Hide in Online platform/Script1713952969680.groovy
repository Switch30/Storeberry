...
WebUI.click(findTestObject('Categories/option_Hide in online plaform'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Categories/red_Status'), 20)

WebUI.click(findTestObject('Categories/button_Select All'))

WebUI.click(findTestObject('Object Repository/Categories/button_Action'))

WebUI.click(findTestObject('Object Repository/Categories/option_Show in online plaform'))
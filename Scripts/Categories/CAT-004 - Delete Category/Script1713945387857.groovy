...
WebUI.click(findTestObject('Categories/button_Action'))

WebUI.click(findTestObject('Categories/option_Delete the category'))

WebUI.click(findTestObject('Categories/button_OK_delete'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/Categories/category_data', [('categoryName') : catName]), 20)
